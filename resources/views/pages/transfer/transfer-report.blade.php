        ...
        <table class="table table-striped text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{date('h:i:a',strtotime($all_transfer->created_at))}}</td>
              @if($all_transfer->transfer_approve == 2)
              <td>
                <button class="btn btn-success form-control" type="button" name="button">อนุมัติ</button>
              </td>
              @elseif($all_transfer->transfer_approve == 1)
              <td>
                <button class="btn btn-danger form-control" type="button" name="button">ปฎิเสธ</button>
              </td>
